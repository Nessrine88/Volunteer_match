...
class ApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application" do
    assert_difference("Application.count") do
      post applications_url, params: { application: { status: @application.status, user_id: @application.user_id } }
    end
  ...
  test "should update application" do
    patch application_url(@application), params: { application: { status: @application.status, user_id: @application.user_id } }
